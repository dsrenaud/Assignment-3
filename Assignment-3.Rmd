...
#Higher bias
hist(higha$freq,xlab = "Frequency",ylab = "Number of codons", main= "anaerococcus high bias")
hist(highb$freq,xlab = "Frequency", ylab="Number of codons", main= "E coli high bias")
