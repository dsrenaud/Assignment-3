...
prot_composition
barplot(prot_composition,xlab="nucleotide",ylab="frequency",main="E-coli Amino acid composition")
...
#1884 1226 1388 1692 3305 2077 1245 4259 3931 6514  949 2163 2111 1759 3009 4709 2145 2038  751 2299 
count(anprot[[2]],alphabet = aa,wordsize = 1)

# A    C    D    E    F    G    H    I    K    L    M    N    P    Q    R    S    T    V    W    Y 
# 1274  931 1340 1702 2258 1634  751 3399 3771 4391 1008 2138 1012 1366 2514 2919 1609 1590  530 1774 
...
prot_counts2 <- count(anpro, alphabet = aa, wordsize = 3)
prot_counts2

barplot(anprot_composition, xlab = "aminoacid", ylab="propotion", main="Anaerococcus composition")
